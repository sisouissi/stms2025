...
Le tabagisme, et plus particulièrement son intensité, augmente la sévérité du SAOS, ce qui souligne l’importance d’intégrer le sevrage tabagique dans la prise en charge globale des patients.` },
  { id: 'p42', title: "Le syndrome d’apnées-hypopnées obstructives du sommeil en milieu professionnel : Dépistage précoce par le médecin du travail", authors: "I. MASMOUDI*- M. SELLAMI**- K. KHARRAT *- H.SAHNOUN * D. KARRAY***-T. BOUASSIDA***", affiliation: "groupement médecine de travail de sfax", summary: `INTRODUCTION :
Le syndrome d’apnées-hypopnées obstructives du sommeil (SAHOS) est une pathologie fréquente, souvent sous-diagnostiquée. Ses conséquences sont la somnolence diurne, la baisse de la vigilance, le risque accru d’accidents du travail et de la route et l’altération de la santé cardiovasculaire. Le milieu professionnel constitue un cadre pertinent pour le dépistage, en particulier dans les secteurs à risque (conducteurs, postes de sécurité, travail en horaires décalés).
Objectif : 
Les objectifs de ce travail étaient  d’établir un protocole d’identification précoce des travailleurs présentant un SAHOS, de les orienter vers une exploration du sommeil et de réduire  les risques professionnels afin d’améliorer la qualité de vie au travail.
METHODES : 
Nous avons mené une étude rétrospective, portant sur les travailleurs suspectés d’avoir un SAHOS, colligés dans la consultation du groupement de médecine de travail de Sfax de novembre 2024 à juin 2025 avec analyse des dossiers médicaux.
Nous avons utilisé l'auto-questionnaire STOP lors de la consultation périodique par le médecin du travail.  Un score supérieur à 2 indique une probabilité de SAHOS.
Un examen clinique complet a été effectué dans tous les cas, avec une attention spécifique portée à la sphère ORL (voies respiratoires supérieures) pour détecter d’éventuelles anomalies favorisant l’obstruction des voies aériennes pendant le sommeil.
Les cas sélectionnés ont répondu aux questionnaires des scores d'Epworth et STOP-Bang pour identifier les cas suspects SAHOS.
 Les sujets ayant une suspicion de SAHOS ( score STOP-Bang≥3) ont eu une polygraphie ventilatoire.
RESULTATS
Nous avons retenu 13 cas suspectés de SAHOS, 10 étaient de sexe masculin et 3 de sexe féminin. L’âge moyen était de 46 ans. 
Parmi les cas étudiés, 3 occupaient le poste de chauffeur et un cas était grutier. Les autres cas étaient répartis sur divers postes, sans spécificité particulière liée au poste occupé
Une déviation septale obstructive était notée dans 5 cas, et une anomalie valvaire dans un cas. 
Les paramètres anthropométriques ont montré que 4 cas présentant un tour de cou > 43 cm, indice de masse corporelle (IMC) était de plus de 35 kg/m² dans 6 cas.
Les résultats de la spirométrie ont objectivé un syndrome restrictif léger dans un cas.
Une polygraphie ventilatoire a confirmé de SAHOS sévère dans 5 cas avec indication de pression positive continue (PPC). 
Pour les 5 cas de SAHOS sévère : l’éviction du travail de nuit était indiquée dans 1 cas, une inaptitude provisoire à la conduite d’engins a été déclarée dans un cas, l’aptitude au travail a été déclarée dans deux cas et le devenir professionnel était un départ à la retraite dans un cas.
CONCLUSION :
Le dépistage précoce du SAHOS en milieu professionnel est efficace et bénéfique non seulement pour la santé des salariés et la sécurité au travail mais aussi pour la collectivité et la sécurité publique. Il permet une meilleure prise en charge  et une prévention  des complications. La coopération entre médecins du travail et le médecin spécialiste du sommeil permet un parcours de soins fluide.` },
