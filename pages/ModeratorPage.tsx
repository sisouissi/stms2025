...
import { RefreshCw, AlertCircle, Loader, ArrowLeft } from 'lucide-react';
      ...
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="space-y-4">
          {isLoading && questions.length === 0 ? (
            ...
            questions.map((q) => (
              <div key={q.id} className="bg-white rounded-lg shadow-md border border-slate-200 p-5 animate-fade-in-up">
