        ...
        <div className="flex flex-col flex-grow min-h-0">
            ...
            <div className="p-4 border-t border-slate-200 flex-shrink-0 bg-slate-50 rounded-b-2xl">
                <div className="flex flex-col items-center">
                    <button onClick={handleToggleListening} className={`w-16 h-16 rounded-full flex items-center justify-center text-white transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 ${isListening ? 'bg-rose-600 hover:bg-rose-700' : 'bg-gradient-to-br from-cyan-400 to-blue-600 hover:from-cyan-500 hover:to-blue-700'}`}>
